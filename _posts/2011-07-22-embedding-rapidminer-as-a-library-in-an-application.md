...
![Flow for creating an example set]({{ site.url }}{{ site.baseurl }}/assets/images/2011/07/rapidminer_flow2.png "Flow for creating an example set")
...
![Example RapidMiner canvas]({{ site.url }}{{ site.baseurl }}/assets/images/2011/07/rapidminer-canvas.png "Creating a sample example set")

Now in the *Parameters* tab, set the *Set Role* parameters like so:


![Screenshot of Setting teamID attribute as the id]({{ site.url }}{{ site.baseurl }}/assets/images/2011/07/rapidminer-set-role.png "Setting teamID attribute as the id")
...
![Attributes in RapidMiner Meta Data View]({{ site.url }}{{ site.baseurl }}/assets/images/2011/07/tts.png "Attributes in RapidMiner Meta Data View")
