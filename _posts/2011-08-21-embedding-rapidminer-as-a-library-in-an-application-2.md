...
![RapidMiner example set values]({{ site.url }}{{ site.baseurl }}/assets/images/2011/08/rapidminer-example-values.png "RapidMiner example set values")
...
![Attribute mapping for Leader]({{ site.url }}{{ site.baseurl }}/assets/images/2011/08/attribute_mappings.png "Attribute mapping for Leader")
